    ...
    const createInvitationPress = () => {
        Alert.alert(
            ...
            [
                ...
                {
                    text: 'نعم',
                    onPress: () => navigation.navigate(ScreenNames.CreateInvetation, { eventType: eventTitle[0]?.eventTitle, eventTitleId: eventTitleId, reqData: filterReqAccEventFile,  eventName :eventName }),
